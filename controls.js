...
function adjustVKLayout() {
    ...
    keyState['a+b'][0].style = makeVKStyle(offTop + vkh - baseSize * 0.5, window.innerWidth - abSize * 2, abSize, abSize, fontSize)
    keyState['b'][0].style = makeVKStyle(offTop + vkh - baseSize * 0.5, window.innerWidth - abSize * 3, abSize, abSize, fontSize)
